...
describe( 'getPoints', () => {
  ...
  it( 'should return correct points of a path (with cubic beziers)', () => {
    const attributes = { d: 'M20,20h50v20C70,45,80,40,80,35L90,30H50V50c5,-3,0,-7,-5,-10l-5,-10Z' };
  ...
  it( 'should return correct points of a path (with shorthand cubic beziers)', () => {
    const attributes = { d: 'M100,100S175,50,200,100s100,10,100,0' };
  ...
  it( 'should return correct points of a path (with quadratic beziers)', () => {
    const attributes = { d: 'M20,20h50v20Q70,45,80,35L90,30H50V50q5,-3,-5,-10l-5,-10Z' };
  ...
  it( 'should return correct points of a path (with shorthand quadratic beziers)', () => {
    const attributes = { d: 'M300,400Q450,200,600,400T900,500t100,0' };
